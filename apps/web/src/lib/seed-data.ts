export const logoDispute = {
  ...
  validators: [
    { model: "gpt-4.1", vote: "partial_refund", confidence: 0.88, fee: "0.00042" },
    { model: "claude-3-7-sonnet", vote: "partial_refund", confidence: 0.84, fee: "0.00039" },
    { model: "gemini-2.5-pro", vote: "release_60_percent", confidence: 0.79, fee: "0.00036" }
  ],
  verdict: {
